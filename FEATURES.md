...
- **Movement and aim as formulas** Write a controller as a text file of formulas in `baritone/control/`, reload it in game, no rebuild. Terrain queries in your own frame, ~45 state variables, errors that point at the line. It cannot break a precise aim, cannot loop, and cannot crash the tick.
